...
ActiveRecord::Schema.define(version: 20151026193748) do
  ...
  create_table "blog_post_taggings", force: :cascade do |t|
  ...
  create_table "grantees_organizations", force: :cascade do |t|
  ...
  create_table "jobs_organizations", force: :cascade do |t|
